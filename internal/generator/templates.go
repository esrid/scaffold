...
// registerGeneratedRoutes mounts all model HTTP routes onto mux. Each
// model gets its own sub-mux behind http.StripPrefix — stdlib has no
// chi.Mount/chi.Route, this is the direct equivalent.
